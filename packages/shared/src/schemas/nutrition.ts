...
export const FoodCategorySchema = z.enum(['FRUITS', 'VEGETABLES', 'GRAINS', 'PROTEINS', 'DAIRY', 'FATS', 'SPORTS_NUTRITION', 'BEVERAGES', 'SNACKS'])
export const MealTypeSchema = z.enum(['BREAKFAST', 'LUNCH', 'DINNER', 'SNACK', 'PRE_WORKOUT', 'POST_WORKOUT', 'DURING_RACE'])
