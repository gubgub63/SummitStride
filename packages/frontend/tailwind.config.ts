    ...
    function({ addUtilities, addComponents, theme }) {
      ...
      addComponents({
        ...
        '.card': {
          ...
          'box-shadow': '0 25px 60px -40px rgba(19, 26, 56, 0.5)',
          color: theme('colors.foreground'),
          'backdrop-filter': 'blur(12px)',
        },
        '.dark .card': {
          border: '1px solid rgba(125, 130, 255, 0.25)',
          'background-color': 'rgba(15, 20, 45, 0.9)',
          'box-shadow': '0 30px 70px -45px rgba(5, 7, 20, 0.85)',
        ...
        '.input': {
          ...
          'transition-duration': '200ms',
          'focus-visible:outline': 'none',
          'focus-visible:ring-2': `ring-${theme('colors.primary.200')}`,
          'focus-visible:ring-offset': '2px',
          'focus-visible:ring-offset-color': theme('colors.background'),
